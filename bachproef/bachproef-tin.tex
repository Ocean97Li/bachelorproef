...
\lstdefinelanguage{JavaScriptSolidity}{
	keywords={pragma,uint,struct,string,break, case, catch, continue, memory, debugger, default, delete, do, else, false, finally, for, function, if, in, instanceof, new, null, return, constructor, contract, switch, this, constructor, throw, view, true, try, typeof, it, assert, mapping, var, void, while, with, public, private},
	morecomment=[l]{//},
	morecomment=[s]{/*}{*/},
	morestring=[b]',
	morestring=[b]",
